...
[![Live Demo](https://img.shields.io/badge/Live%20Demo-Online-success?style=for-the-badge&logo=cloudflare)](https://usage-departmental-dimensional-oils.trycloudflare.com)
[![API Health](https://img.shields.io/badge/API-Operational-brightgreen?style=for-the-badge)](https://usage-departmental-dimensional-oils.trycloudflare.com/health)
[![PostgreSQL](https://img.shields.io/badge/PostgreSQL-16-blue?style=for-the-badge&logo=postgresql)](https://usage-departmental-dimensional-oils.trycloudflare.com/health/db)
[![FastAPI](https://img.shields.io/badge/FastAPI-0.115-009688?style=for-the-badge&logo=fastapi)](https://usage-departmental-dimensional-oils.trycloudflare.com/docs)

### 🔗 Live Deployment & API Links

| Service | Public URL | Description |
| :--- | :--- | :--- |
| 🌐 **Live Web App** | **[usage-departmental-dimensional-oils.trycloudflare.com](https://usage-departmental-dimensional-oils.trycloudflare.com)** | Full responsive SSR web application |
| 📖 **API Docs (Swagger)** | **[usage-departmental-dimensional-oils.trycloudflare.com/docs](https://usage-departmental-dimensional-oils.trycloudflare.com/docs)** | Interactive Swagger UI API playground |
| 🏥 **API Health Check** | **[usage-departmental-dimensional-oils.trycloudflare.com/health](https://usage-departmental-dimensional-oils.trycloudflare.com/health)** | Live server uptime probe |
| 🗄️ **Database Health Check** | **[usage-departmental-dimensional-oils.trycloudflare.com/health/db](https://usage-departmental-dimensional-oils.trycloudflare.com/health/db)** | PostgreSQL connectivity probe |
